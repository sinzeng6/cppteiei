<%-- 
    Document   : cart
    Created on : Nov 5, 2018, 11:45:57 AM
    Author     : Admin
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title  -->
        <title>LONGDOMDOSIER - Furniture Ecommerce | Cart</title>
        ...
        <div class="main-content-wrapper d-flex clearfix">
            ...
            <header class="header-area clearfix">
                ...
                <div class="cart-fav-search mb-100">
                    <a href="CartServlet" class="cart-nav"s><img src="img/core-img/cart.png" alt=""> Cart <span>(${cart.totalQuantity})</span></a>
                                        ...
                                        <c:forEach items="${cart.lineItems}" var="line" varStatus="vs">
                                            <tr>
                                                <td class="cart_product_img">
                                                    <a href="GetProductServlet?productcode=${line.product.productcode}"><img src="PicProject/${line.product.productcode}.jpg" alt="Product"></a>
                                                </td>
                                                <td class="cart_product_desc">
                                                    <h5>${line.product.productbrandname}</h5>
                                                </td>
                                                <td class="price">
                                                    <span>$${line.product.productprice}</span>
                                                </td>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="cart-summary">
                                ...
                                <ul class="summary-table">
                                    <li><span>subtotal:</span> <span>$${sessionScope.cart.totalPrice}</span></li>
                                    <li><span>delivery:</span> <span>Free</span></li>
                                    <li><span>total:</span> <span>$${cart.totalPrice}</span></li>
                                </ul>
                                <div class="cart-btn mt-100">
                                    <a href="CheckoutPageServlet" class="btn amado-btn w-100">Checkout</a>
                                </div>
                            </div>
                        </div>
